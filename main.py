...
def preprocessing(data_type, files):
    ...
    for file in tqdm(files):
        ...
        for item in parser.get_data():
            ...
            for dep in nlp_res['sentences'][0]['enhancedPlusPlusDependencies']:
                data['combined-parsing'].append('{}/dep={}/gov={}'.format(dep['dep'], dep['dependent'] - 1, dep['governor'] - 1))
    ...
    with open('JMEE_{}_filter_no_timevalue.json'.format(data_type), 'w') as f:
        json.dump(result, f, indent=2)


if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--data', help="Path of ACE2005 English data", default='./ace_2005_td_v7/data/English')
